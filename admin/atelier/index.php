...
while ($row = mysql_fetch_assoc($result)) {
  ...
  print('</form>');
  print('<form action="down.php" class="delete" method="post" onsubmit="return confirm(\''.$row['title'].'を下に移動して宜しいですか？\');">');
  print('<input type="hidden" name="down" value="'.$row['id'].'" />');
  print('<input type="submit" value="下へ" />');
  print('</form>');
  print('<form action="up.php" class="delete" method="post" onsubmit="return confirm(\''.$row['title'].'を上に移動して宜しいですか？\');">');
  print('<input type="hidden" name="up" value="'.$row['id'].'" />');
  print('<input type="submit" value="上へ" />');
  print('</form>');
  print('</div>');
