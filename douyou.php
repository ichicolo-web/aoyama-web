    ...
    <div class="contents">
      ...
      <div class="map">
        <p>
          ...
          <br />
          3ヶ月かけて作曲家の想いや曲想を勉強し、「からたちの花」を唄ったり、「落葉松」や「さくら横丁」をピアノの音型を味わいながら唄ったりしました。「第九」もドイツ語(カタカナから出発)にチャレンジ！<br />
NHK東日本大震災プロジェクト「花は咲く」も歌いました。</p><br />

  <div class="osirase02">
  <ul>
            <li><span>日時：</span>第1月曜日　午前10:00～11:30</li>
            <li><span>場所：</span>湘南鷹取3丁目　青山宅</li>
            <li><span>定員：</span>20名程度</li>
			<li><span>会費：</span>1,000円(御家族お2人目から500円)&nbsp;&nbsp;歌集を2冊(1,000円程度)御購入いただきます。</li>
          ...
          <p>
          2010年3月に始めた会ですが、参加されている方からは、「とてもアットホームな雰囲気」、「この齢で新しいお友達が出来ました」、「歌を通して、季節を身近に感じられるようになりました」、「その時間唄うだけですが、1年で150曲も唄えたことになるんですね！」、「作詞作曲、音についての解説を聞いて唄うと、心にしっかり刻まれます」など、好評をいただいております。
          </p><br />
          
          <div class="osirase03">
  <ul>
            <li><span>歌指導/柴田　美嘉</span>：故川田正子、故海沼実の各氏に童謡の指導を受ける。戸塚生涯学習ナビゲーター</li>
            <li><span>ピアノ/青山由貴子</span>：元ヤマハ音楽教室システム講師　合唱伴奏歴40年　横須賀まなび館情報登録講師</li>
            </ul>
            </div>
